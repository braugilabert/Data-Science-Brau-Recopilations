...
# Selecciona la primera fila de cada grupo
DT[c("b", "c"), mult = "first"]

# Selecciona la primera y ultima fila de cada grupo
DT[c("b", "c"), .SD[c(1, .N)], by = .EACHI] #Con .EACHI ejecutamos la sección j para elemento del grupo
